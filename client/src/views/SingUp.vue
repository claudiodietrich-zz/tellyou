      ...
      <div class="container">
        ...
        <div class="columns">
          <div class="column is-half is-offset-one-quarter">
            <div class="box">
              <b-field
                v-bind:label="$t('view.singUp.form.label.name')"
              ...
              <b-field
                v-bind:label="$t('view.singUp.form.label.email')"
              ...
              <b-field
                v-bind:label="$t('view.singUp.form.label.password')"
